# HeavyDrops Transcoder v6.0.28 Installer
...
Write-Host "  HeavyDrops Transcoder v6.0.28 Installer" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$LauncherContent = @"
@echo off
title HeavyDrops Transcoder v6.0.28
cd /d "%~dp0"
echo ========================================
echo   HeavyDrops Transcoder v6.0.28
echo ========================================
echo.
...
$PSLauncherContent = @"
`$Host.UI.RawUI.WindowTitle = "HeavyDrops Transcoder v6.0.28"
Set-Location "`$PSScriptRoot"
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  HeavyDrops Transcoder v6.0.28" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$Shortcut.Description = "HeavyDrops Transcoder v6.0.28"
$Shortcut.Save()
