# HeavyDrops Transcoder v7.5.0 Installer
...
Write-Host "  HeavyDrops Transcoder v7.5.0 Installer" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$LauncherContent = @"
@echo off
title HeavyDrops Transcoder v7.5.0
cd /d "%~dp0"
echo ========================================
echo   HeavyDrops Transcoder v7.5.0
echo ========================================
echo.
...
$PSLauncherContent = @"
`$Host.UI.RawUI.WindowTitle = "HeavyDrops Transcoder v7.5.0"
Set-Location "`$PSScriptRoot"
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  HeavyDrops Transcoder v7.5.0" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$Shortcut.Description = "HeavyDrops Transcoder v7.5.0"
$Shortcut.Save()
