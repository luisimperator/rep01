# HeavyDrops Transcoder v6.0.22 Installer
...
Write-Host "  HeavyDrops Transcoder v6.0.22 Installer" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$LauncherContent = @"
@echo off
title HeavyDrops Transcoder v6.0.22
cd /d "%~dp0"
echo ========================================
echo   HeavyDrops Transcoder v6.0.22
echo ========================================
echo.
...
$PSLauncherContent = @"
`$Host.UI.RawUI.WindowTitle = "HeavyDrops Transcoder v6.0.22"
Set-Location "`$PSScriptRoot"
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  HeavyDrops Transcoder v6.0.22" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$Shortcut.Description = "HeavyDrops Transcoder v6.0.22"
$Shortcut.Save()
