# HeavyDrops Transcoder v6.3.2 Installer
...
Write-Host "  HeavyDrops Transcoder v6.3.2 Installer" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$LauncherContent = @"
@echo off
title HeavyDrops Transcoder v6.3.2
cd /d "%~dp0"
echo ========================================
echo   HeavyDrops Transcoder v6.3.2
echo ========================================
echo.
...
$PSLauncherContent = @"
`$Host.UI.RawUI.WindowTitle = "HeavyDrops Transcoder v6.3.2"
Set-Location "`$PSScriptRoot"
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  HeavyDrops Transcoder v6.3.2" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
$Shortcut.Description = "HeavyDrops Transcoder v6.3.2"
$Shortcut.Save()
